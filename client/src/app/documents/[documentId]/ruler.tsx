...
const Ruler = () => {
  ...
  const handleMouseMove = (e: MouseEvent) => {
    if ((isDraggingLeft || isDraggingRight) && rulerContainerRef.current) {
      const container =
        rulerContainerRef.current.querySelector("#ruler-container");
      ...
      <div id="ruler-container" className="w-full h-full relative">
        ...
        <div className="absolute inset-x-0 bottom-0 h-full">
          <div className="relative h-full w-[816px]">
            {markers.map((marker) => {
              const position = (marker * 816) / 82; // maybe 80
